...
**Пометка [ЩАДЯЩЕЕ]** стоит у 22 упражнений: это те, которые
приложение считает безопасными при ограниченной подвижности. Отдельной
главой ниже идут 11 из них — специальный блок
...
1. **Изометрические упражнения.** Глава «Щадящие»: изометрия шеи вперёд, вбок и на поворот, изометрия плеча у стены, прижатие спины к стулу, напряжение бедра сидя. Приложение предлагает их зонам с ограниченной подвижностью; дозировка — треть усилия, 5 секунд, дыхание не задерживается. Допустимо ли это при активном воспалении? Не нужно ли исключать изометрию при повышенном артериальном давлении полностью — сейчас она лишь помечена противопоказанием.
2. **Амплитуда при обострении.** Приложение в обострение не убирает зону из программы, а даёт ей микроамплитудные упражнения: ограничение считается поводом мягко развивать зону, а не забрасывать её. Правильный ли это подход?
3. **Вытяжение позвоночника висом.** Мёртвый вис и вис для осанки (глава «Турник и брусья»). Сейчас они доступны только в программе общей формы и при анкилозирующем спондилите не предлагаются ни при каких ответах анкеты. Верно ли такое разделение?
4. **Дозировка.** Разумны ли указанные длительности и число повторений для домашних ежедневных занятий? Что стоит уменьшить, что можно увеличить?
5. **Чего не хватает.** Какие упражнения следует добавить, чтобы домашняя программа была полноценной? И наоборот — что убрать.
...
#### 1. Диафрагмальное дыхание **[ЩАДЯЩЕЕ]**

**Программа:** реабилитация Бехтерева · **Зона:** мышцы корпуса · **Дозировка:** 180 сек

**Уровень:** начальный · **Исходное положение:** лёжа на спине
...
#### 2. Дыхание с раскрытием рёбер **[ЩАДЯЩЕЕ]**
...
#### 4. Дыхание на расслабление **[ЩАДЯЩЕЕ]**
...
#### 1. Повороты головы **[ЩАДЯЩЕЕ]**

**Программа:** реабилитация Бехтерева · **Зона:** шейный отдел · **Дозировка:** 10 повт.
...
#### 2. Наклоны головы к плечу **[ЩАДЯЩЕЕ]**

**Программа:** реабилитация Бехтерева · **Зона:** шейный отдел · **Дозировка:** 6 повт.
...
#### 3. Круги плечами **[ЩАДЯЩЕЕ]**

**Программа:** реабилитация Бехтерева · **Зона:** плечевой пояс · **Дозировка:** 20 повт.
...
#### 4. Наклоны таза лёжа **[ЩАДЯЩЕЕ]**

**Программа:** реабилитация Бехтерева · **Зона:** тазобедренные суставы · **Дозировка:** 12 повт.
...
**Программа:** общая форма · **Зона:** всё тело · **Дозировка:** 30 повт.

**Уровень:** начальный · **Исходное положение:** стоя без опоры
...
**Программа:** общая форма · **Зона:** плечевой пояс · **Дозировка:** 20 повт.
...
#### 1. Самомассаж основания черепа **[ЩАДЯЩЕЕ]**
...
**Программа:** реабилитация Бехтерева · **Зона:** позвоночник · **Дозировка:** 12 повт.

**Уровень:** начальный · **Исходное положение:** на четвереньках
...
**Реакция приложения на жалобу:** боль в суставе → исключить упражнение.

#### 2. Ротация грудного отдела

**Программа:** реабилитация Бехтерева · **Зона:** позвоночник · **Дозировка:** 16 повт.
...
#### 4. Выравнивание у стены **[ЩАДЯЩЕЕ]**
...
**Программа:** реабилитация Бехтерева · **Зона:** позвоночник · **Дозировка:** 8 повт.

**Уровень:** начальный · **Исходное положение:** лёжа на животе
...
**Уровень:** средний · **Исходное положение:** лёжа на животе
...
**Программа:** реабилитация Бехтерева · **Зона:** мышцы корпуса · **Дозировка:** 12 повт.

**Уровень:** средний · **Исходное положение:** лёжа на спине
...
**Уровень:** средний · **Исходное положение:** на четвереньках
...
**Программа:** реабилитация Бехтерева · **Зона:** плечевой пояс · **Дозировка:** 10 повт.
...
**Реакция приложения на жалобу:** боль в суставе → исключить зону.

#### 12. Наружная ротация плеча

**Программа:** реабилитация Бехтерева · **Зона:** плечевой пояс · **Дозировка:** 14 повт.
...
#### 13. Сведение лопаток **[ЩАДЯЩЕЕ]**

**Программа:** реабилитация Бехтерева · **Зона:** плечевой пояс · **Дозировка:** 12 повт.
...
**Программа:** реабилитация Бехтерева · **Зона:** плечевой пояс · **Дозировка:** 30 повт.
...
**Уровень:** начальный · **Исходное положение:** на коленях
...
**Программа:** реабилитация Бехтерева · **Зона:** тазобедренные суставы · **Дозировка:** 24 повт.

**Уровень:** начальный · **Исходное положение:** лёжа на боку
...
**Программа:** реабилитация Бехтерева · **Зона:** ноги · **Дозировка:** 12 повт.
...
**Программа:** реабилитация Бехтерева · **Зона:** ноги · **Дозировка:** 15 повт.
...
**Программа:** общая форма · **Зона:** ноги · **Дозировка:** 15 повт.
...
**Программа:** общая форма · **Зона:** ноги · **Дозировка:** 20 повт.

**Уровень:** средний · **Исходное положение:** стоя без опоры
...
**Программа:** общая форма · **Зона:** плечевой пояс · **Дозировка:** 12 повт.
...
**Уровень:** средний · **Исходное положение:** лёжа на боку
...
**Программа:** общая форма · **Зона:** мышцы корпуса · **Дозировка:** 20 повт.
...
**Программа:** общая форма · **Зона:** позвоночник · **Дозировка:** 12 повт.
...
**Программа:** общая форма · **Зона:** тазобедренные суставы · **Дозировка:** 15 повт.
...
**Программа:** общая форма · **Зона:** плечевой пояс · **Дозировка:** 15 повт.
...
**Программа:** обе программы · **Зона:** шейный отдел · **Дозировка:** 8 повт.
...
**Программа:** обе программы · **Зона:** шейный отдел · **Дозировка:** 5 повт.
...
**Программа:** обе программы · **Зона:** плечевой пояс · **Дозировка:** 5 повт.
...
**Программа:** обе программы · **Зона:** позвоночник · **Дозировка:** 6 повт.
...
**Программа:** обе программы · **Зона:** позвоночник · **Дозировка:** 8 повт.
...
**Программа:** обе программы · **Зона:** ноги · **Дозировка:** 8 повт.
...
**Программа:** обе программы · **Зона:** тазобедренные суставы · **Дозировка:** 8 повт.
...
**Программа:** общая форма · **Зона:** плечевой пояс · **Дозировка:** 10 повт.
...
**Программа:** общая форма · **Зона:** плечевой пояс · **Дозировка:** 5 повт.
...
**Программа:** общая форма · **Зона:** плечевой пояс · **Дозировка:** 6 повт.
...
**Программа:** общая форма · **Зона:** мышцы корпуса · **Дозировка:** 10 повт.
...
**Программа:** общая форма · **Зона:** мышцы корпуса · **Дозировка:** 8 повт.
...
**Программа:** общая форма · **Зона:** плечевой пояс · **Дозировка:** 8 повт.
